...
import { ThemeAntiFlash } from "@/components/providers/theme-anti-flash";
import { SiteHeader } from "@/components/widgets/site-header/site-header";
  ...
  return (
    ...
    >
      <body className="flex min-h-dvh flex-col">
        <ThemeAntiFlash theme={initialTheme} />
        <RootProviders
          locale={locale}
          messages={messages}
          timeZone={timeZone}
